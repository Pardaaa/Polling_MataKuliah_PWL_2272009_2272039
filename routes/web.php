...
Route::get('datamahasiswa', function () { return view('layouts\mahasiswa\datamahasiswa'); })->middleware('checkRole:admin');
...
Route::delete('hapus/{id}', [App\Http\Controllers\MahasiswaController::class, 'hapus'])->name('hapus');